...
public class ProductOfArrayExceptSelf {
	...
	public void getProductByLRmethodConstantSpace(int[] nums) {
		...
		//Intsead of a array use a variable to find the product of elements to its right,
		//Multiply its position directly to the result [ left_products ] array.
		
		int R = 1;
		
		//From index N-1, keep track of the product of all elements right of index i.
		for(int i=left_products.length - 1; i>=0; i--)
		{
			left_products[i] = left_products[i] * R;
			R = R * nums[i];
		}
	...
	public static void main(String[] args) {
		...
		obj.getProductByLRmethodConstantSpace(nums);
